...
test("방금 그 곡", () => {
    function solution(m, musicinfos) {
        ...
        const replace = new Map([["C#", 1], ["D#", 2], ["F#", 3], ["G#", 4], ["A#", 5], ["E#", 6], ["B#", 7]])
        let i = 0
        ...
        const targetM = m.match(regex).map(code => {
            if (replace.has(code)) {
                return replace.get(code)
            }
            return code
    ...
    const case1 = ["ABCDEFG", ["12:00,12:14,HELLO,CDEFGAB", "13:00,13:05,WORLD,ABCDEF"], "HELLO"]
    expectEqualTest(solution(case1[0], case1[1]), case1[2])
    const case2 = ["CC#BCC#BCC#BCC#B", ["03:00,03:30,FOO,CC#B", "04:00,04:08,BAR,CC#BCC#BCC#B"], "FOO"]
    expectEqualTest(solution(case2[0], case2[1]), case2[2])
    const case3 = ["ABCDEFG", ["12:00,12:14,HELLO,CDEFGAB", "13:00,13:05,WORLD,ABCDEF"], "HELLO"]
